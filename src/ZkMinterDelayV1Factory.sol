...
contract ZkMinterDelayV1Factory is IZkMinterV1Factory {
  ...
  /// ./zkout/ZkMinterDelayV1.sol/ZkMinterDelayV1.json.
  ...
  /// @notice Error thrown when attempting to create a minter delay with a zero address admin.
  error ZkMinterDelayV1Factory__InvalidAdminAddress();
  ...
  /// @notice Deploys a new `ZkMinterDelayV1` contract using CREATE2. This method takes bytes argument
  /// and is meant to be used in a unified factory for all capped minter extensions.
  /// @param _mintable A contract used as a target when calling mint.
  /// @param _args The args to deploy ZkMinterDelayV1.
  ...
  {
    if (_admin == address(0)) {
      revert ZkMinterDelayV1Factory__InvalidAdminAddress();
    }
